...
// Code function di sini 
function balikKata($kalimat1){
    $panjangStr = strlen($kalimat1);
    $tampung = "";
    ...
    function reverseString($kalimatBalik ){
        $balik = balikKata($kalimatBalik);
        echo $balik . "<br>";
    }
...
// Code function di sini
    ...
    function palindrome( $kataPali){
        $balikKata = balikKata ($kataPali);
        if($balikKata === $kataPali){
